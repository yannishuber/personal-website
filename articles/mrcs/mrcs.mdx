...
![Kaeserberg museum railway](./assets/kaeserberg-1.jpg "One of three main levels of the railway. Picture: Adrian Moser")
...
![Domino control desk](./assets/domino.jpg "The main control desk used by the operators to schedule itineraries on the manual part of the railway. Picture: Adrian Moser")
...
![MRCS interface cards](./assets/interfaces.jpg "The new interface cards plugged into the existing rack.")
